<div class="card m-3">
    ...
    <form method="POST" action="/sections">
            ...
            <div class="form-group">
                ...
                <textarea  id="editor"class="form-control" id="sectionContent" name="section_content" rows="4" required></textarea>
            </div>
            <div class="form-group">
                <label for="sectionResources">Section Resources:</label>
                <textarea id="editor" class="form-control" id="sectionResources" name="section_resources" rows="4" required></textarea>
            </div>
            <div  class="form-group">
            ...
            <div class="form-group">
                ...
                <textarea  id="editor" class="form-control" id="assignment" name="assignment" rows="4" required></textarea>
            </div>
