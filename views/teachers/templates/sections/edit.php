<div class="card m-3">
    ...
    <form>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control" id="sectionContent" name="section_content" rows="4" required><?=$section["section_content"] ?></textarea>
            </div>
            <div class="form-group">
                <label for="sectionResources">Section Resources:</label>
                <textarea class="form-control" id="sectionResources" name="section_resources" rows="4" required><?=$section["section_resources"] ?></textarea>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control" id="assignment" name="assignment" rows="4" required ><?= $section["assignment"] ?></textarea>
            </div>
